...
namespace TinyCms.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseCmsEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseCmsEntityModel
        {
        ...
        public static MvcHtmlString NopLabelFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression, bool displayHint = true)
        {
            ...
            {
                var resourceDisplayName = value as CmsResourceDisplayName;
