...
using TinyCms.Data.Initializers;
...
namespace TinyCms.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        public virtual void SetDatabaseInitializer()
        {
            ...
            var tablesToValidate = new[] { "User", "Discount", "Order", "Product", "ShoppingCartItem" };
            ...
            var initializer = new CreateTablesIfNotExist<CmsObjectContext>(tablesToValidate, customCommands.ToArray());
